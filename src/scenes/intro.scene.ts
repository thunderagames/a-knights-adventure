...
export class IntroScene extends Phaser.Scene {
    ...
    create(): void {
        this.sound.play(AudioKeysEnum.AudioStep, { volume: 0.1, loop: true })
        this.sound.play(AudioKeysEnum.AudioWind, { volume: 0.1, loop: false })
        this.createAnimations()

        this.add.image(this.scale.width / 2 + 150, this.scale.height - 100, TextureKeysEnum.ImgThunderaLogo).setOrigin(0.5).setDepth(3000).setScale(0.15).setAlpha(0.5)
        ...
        this.bg_layer3.setDisplaySize(this.cameras.main.width, this.cameras.main.height)
        this.bg_layer4.setDisplaySize(this.cameras.main.width, this.cameras.main.height)
        ...
        this.spr_dragon2.setScale(0.3)
        this.spr_dragon2.setAlpha(0.6)
        ...
        timer(150).subscribe(() => {
            this.cameras.main.setLerp(0.04)
            ...
            this.spr_dragon2.setVelocityX(80)
        })
    ...
    private characterAnimationTimeline(): void {
        ...
        timer(4600).subscribe(() => {
            ...
            this.sound.play(AudioKeysEnum.AudioThunder, { volume: 0.2, loop: false })
