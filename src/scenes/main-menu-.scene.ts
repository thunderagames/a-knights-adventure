...
export class MainMenuScene extends Phaser.Scene {
    ...
    create() {
        ...
        let title = this.add.text(this.scale.width / 2, 70, 'KNIGHT WARRIOR', { fontSize: 34, fontStyle: 'bold', shadow: { color: '#FF8', offsetX: -3, offsetY: 2, blur: 4, fill: true }, color: '#242323' }).setOrigin(0.5)
        this.tweens.add({
            targets: title,
            alpha: 0.4,
            duration: 500,
